...
func (c *messageSenderClient) Send(ctx context.Context, in *MessageReq, opts ...grpc.CallOption) (*MessageResp, error) {
	out := new(MessageResp)
...
func (UnimplementedMessageSenderServer) Send(context.Context, *MessageReq) (*MessageResp, error) {
